...
public class FormPayloadBuilder {
    ...
    private FormPayloadBuilderRequest inner;

    public FormPayloadBuilder(FormPayloadBuilderRequest inner) {
        this.inner = inner;
    }

    public FormPayloadBuilder param(String key, String value) {
        ++parameterCount;
        inner.param(key, value);
        return this;
    }
